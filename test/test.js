...
describe('Database Setup', () => {
  ...
  test('Questions table field "asker_name" is of type varchar', () => {
  ...
  test('Questions table field "body" is of type varchar', () => {
  ...
  test('Questions table field "date_written" is of type int', () => {
  ...
  test('Questions table field "email" is of type varchar', () => {
  ...
  test('Questions table field "id" is of type varchar', () => {
  ...
  test('Questions table field "product_id" is of type int', () => {
  ...
  test('Questions table field "question_helpfulness" is of type int', () => {
  ...
  test('Questions table field "question_id" is of type int', () => {
  ...
  test('Questions table field "reported" is of type tinyint', () => {
